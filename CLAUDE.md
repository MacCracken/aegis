...
**aegis** — Cyrius port of a Rust project (1893 lines preserved at `rust-old/`).
...
_TODO: one-or-two-sentence mission statement. What does aegis OWN in the stack? Durable — doesn't change per release._
